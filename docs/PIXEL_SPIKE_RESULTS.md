...
Still outstanding for a full physical matrix: wireless-charging variants, a below-80 % approach to the limit, the widget under Shizuku-only, the 24-hour safety timeout (impractical at real duration; a debug-shortened test is the intended approach), and the Pixel XL / Android 10 unsupported pass.
