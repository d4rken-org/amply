...
The first control adapter targets Pixel charging optimization. Direct control is capability-gated to Pixel 6a and newer phones on Android 15 or newer when Google's charging-optimization controller is present. Pixel combinations without that capability, Samsung, and OnePlus/Oppo remain diagnostics-only.
