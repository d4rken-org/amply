 ...
 * came up empty, so self-service gets its chance first.
 */
@Composable
...
@AmplyPreview
@Composable
private fun UpgradeRestoreSectionPreview() = PreviewWrapper {
...
@AmplyPreview
@Composable
private fun UpgradeRestoreSectionEmphasizedPreview() = PreviewWrapper {
    UpgradeRestoreSection(
        title = "Already upgraded?",
        body = "It looks like you upgraded on this device before.",
        onRestore = {},
        emphasized = true,
        busy = BusyOp.RESTORE,
    )
