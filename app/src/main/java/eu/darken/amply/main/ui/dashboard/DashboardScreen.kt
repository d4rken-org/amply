...
private fun StatusCard(
    ...
    // Not "is it Verified" — a readback of a conditional policy (adaptive) proves the mode is set,
    // not that the charger is acting on it, so it must not earn the confirmed checkmark.
